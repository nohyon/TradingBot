...
var CustomPriceLinePaneView = /** @class */ (function (_super) {
    ...
    CustomPriceLinePaneView.prototype._updateImpl = function () {
...
function getPretransformedContext2D(binding) {
    var ctx = ensureNotNull(binding.canvas.getContext('2d'));
    // scale by pixel ratio
...
var PaneSeparator = /** @class */ (function () {
    ...
    PaneSeparator.prototype.getImage = function () {
        ...
        var ctx = getPrescaledContext2D(res);
...
var LabelsImageCache = /** @class */ (function () {
    ...
    LabelsImageCache.prototype.getLabelImage = function (ctx, text) {
        ...
        if (this._private__hash.has(text)) {
            ...
            var width = Math.round(textWidth + margin * 2);
            var height = this._private__fontSize + margin * 2;
            var canvas = createPreconfiguredCanvas(document, new Size(width, height));
            // Allocate new
            item = {
                text: text,
...
var PriceAxisWidget = /** @class */ (function () {
    ...
    PriceAxisWidget.prototype.optimalWidth = function () {
        ...
        var ctx = getPretransformedContext2D(this._private__canvasBinding);
    ...
    PriceAxisWidget.prototype.paint = function (type) {
        ...
        var topCtx = getPretransformedContext2D(this._private__topCanvasBinding);
        topCtx.clearRect(-0.5, -0.5, this._private__size.w, this._private__size.h);
        this._private__drawCrosshairLabel(topCtx);
    };
...
var PaneWidget = /** @class */ (function () {
    ...
    PaneWidget.prototype.paint = function (type) {
        ...
        if (type !== 1 /* Cursor */) {
            var ctx = getPretransformedContext2D(this._private__canvasBinding);
            this._private__drawBackground(ctx, this._private__backgroundColor());
            if (this._private__state) {
                this._private__drawGrid(ctx);
                this._private__drawWatermark(ctx);
                this._private__drawSources(ctx);
            }
        }
        var topCtx = getPretransformedContext2D(this._private__topCanvasBinding);
        topCtx.clearRect(-0.5, -0.5, this._private__size.w, this._private__size.h);
        this._private__drawCrosshair(topCtx);
    };
...
var PriceAxisStub = /** @class */ (function () {
    ...
    PriceAxisStub.prototype._private__drawBorder = function (ctx) {
    ...
    PriceAxisStub.prototype._private__drawBackground = function (ctx) {
        clearRect(ctx, 0, 0, this._private__size.w, this._private__size.h, this._private__options.layout.backgroundColor);
    };
...
var TimeAxisWidget = /** @class */ (function () {
    ...
    TimeAxisWidget.prototype._private__drawCrosshairLabel = function (ctx) {
        ctx.clearRect(-0.5, -0.5, this._private__size.w, this._private__size.h);
        var model = this._private__chart.model();
        var views = []; // array of arrays
...
var ChartWidget = /** @class */ (function () {
    ...
    ChartWidget.prototype.takeScreenshot = function () {
        ...
        var ctx = getPrescaledContext2D(targetCanvas);
        var targetX = 0;
        var targetY = 0;
        ...
        if (this._private__options.timeScale.visible) {
            ...
            var size = this._private__timeAxisWidget.getSize();
